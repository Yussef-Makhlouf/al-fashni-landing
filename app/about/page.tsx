          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 text-center md:text-right">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-foreground">
                ...
                <br className="hidden md:block" />لــلإعــلان والعــلاقــات العــامــة
              </h1>
              <p className="text-muted-foreground text-lg mb-8 max-w-2xl md:mr-0 mx-auto">
                شــركــة رائــدة فــي مــجــال الإعــلان والعــلاقــات العــامــة، نــســعــى لــتــقــديــم حــلــول إبــداعــيــة تــســاعــد عــمــلائــنــا عــلــى تــحــقــيــق أهــدافــهــم وتــعــزيــز تــواجــدهــم فــي الســوق
              </p>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="lg:w-1/2 text-right">
              ...
              <p className="text-muted-foreground">
                الــيــوم، يــضــم فــريــقــنــا أكــثــر مــن 50 مــحــتــرفــاً فــي مــخــتــلــف مــجــالات الإعــلان والتــســويــق والتــصــمــيــم والعــلاقــات العــامــة، مــلــتــزمــيــن بــتــقــديــم أعــلــى مــســتــويــات الجــودة والإبــداع لــكــل عــمــيــل.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-card rounded-lg overflow-hidden shadow-md border border-border group hover:border-[#186af2]/50 transition-all">
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-[#34a853] font-medium">مــديــرة العــلاقــات العــامــة</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      نــمــتــلــك خــبــرة تــمــتــد لأكــثــر مــن 10 ســنــوات فــي مــجــال الإعــلان والعــلاقــات العــامــة، عــمــلــنــا خــلالــهــا مــع مــئــات العــلامــات التــجــاريــة المــحــلــيــة والعــالــمــيــة
                    </p>
                  </div>
                </div>
              </div>
