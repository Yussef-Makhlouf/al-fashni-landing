...
export const services = [
  ...
  },
  {
    ...
    detailedDescription: "نطور تطبيقات جوال مبتكرة تلبي احتياجات مستخدميك وتضيف قيمة حقيقية لعملك مع تركيز قوي على تجربة المستخدم. نستخدم أحدث التقنيات لبناء تطبيقات سريعة وآمنة ومتوافقة مع مختلف أنظمة التشغيل وأحجام الشاشات."
  },
  {
    id: 7,
    title: "إنتاج الفيديو",
