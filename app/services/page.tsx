...
const services = [
  ...
  {
    id: 6,
    title: "تصميم الهوية البصرية والجرافيك",
    description: "تصميم هويات بصرية مميزة وعناصر جرافيك احترافية لعلامتك التجارية",
    icon: PenTool,
    color: "text-[#ea4235]",
    bgColor: "bg-[#ea4235]/10",
    features: [
      "تصميم شعارات احترافية وفريدة",
      "تصميم هويات بصرية متكاملة",
      "تصميم منشورات السوشيال ميديا",
      "تصميم الموكبس والواجهات",
      "تصميم المواد التسويقية المطبوعة"
    ],
    detailedDescription: "نقدم خدمات تصميم جرافيك متكاملة تشمل تصميم الشعارات والهويات البصرية وتصميم منشورات السوشيال ميديا والموكبس، مع التركيز على الجودة والإبداع والتناسق مع هوية علامتك التجارية."
  },
  {
    id: 7,
    title: "إنتاج الفيديو",
  ...
  {
    id: 8,
    title: "تصميم وتنفيذ الريلز والفيديوهات الإعلانية",
    description: "إنتاج محتوى مرئي جذاب ومؤثر لمنصات التواصل الاجتماعي",
    icon: Video,
    color: "text-[#34a853]",
    bgColor: "bg-[#34a853]/10",
    features: [
      "تصميم وتنفيذ ريلز إبداعية",
      "إنتاج فيديوهات إعلانية قصيرة",
      "تصميم موشن جرافيك جذاب",
      "تحرير ومونتاج احترافي",
      "تحسين المحتوى ليتناسب مع كل منصة"
    ],
    detailedDescription: "نقدم خدمات متكاملة لتصميم وتنفيذ الريلز والفيديوهات الإعلانية التي تساعد في تعزيز تواجدك على منصات التواصل الاجتماعي وجذب انتباه جمهورك المستهدف."
  },
  {
    id: 9,
