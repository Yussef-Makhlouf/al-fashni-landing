...
const services = [
  ...
  {
    id: 6,
    title: "تــطــبــيــقــات الــهــاتــف المــحــمــول",
    description: "تــطــويــر تــطــبــيــقــات مــبــتــكــرة لــلــهــواتــف الــذكــيــة تــلــبــي احــتــيــاجــات عــمــلائــك وتــعــزز تــجــربــتــهــم",
    icon: Smartphone,
    color: "text-[#ea4235]",
    bgColor: "bg-[#ea4235]/10",
  },
  {
    id: 7,
    title: "إنــتــاج الــفــيــديــو",
    description: "إنــتــاج مــحــتــوى مــرئــي احــتــرافــي يــروي قــصــة عــلامــتــك التــجــاريــة ويــجــذب انــتــبــاه جــمــهــورك",
    icon: Video,
    color: "text-[#fabc05]",
    bgColor: "bg-[#fabc05]/10",
  },
  {
    id: 8,
    title: "التــســويــق عــبــر البــريــد الإلــكــتــرونــي",
    description: "حــمــلات بــريــديــة مــخــصــصــة تــســاعــد فــي بــنــاء عــلاقــات دائــمــة مــع عــمــلائــك وزيــادة المــبــيــعــات",
    icon: Mail,
    color: "text-[#34a853]",
    bgColor: "bg-[#34a853]/10",
  },
